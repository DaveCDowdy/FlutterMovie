    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `movies` (`id` INTEGER NOT NULL, `title` TEXT NOT NULL, `genre` TEXT NOT NULL, `rating` TEXT NOT NULL, `image_res_id` INTEGER NOT NULL, `is_favorite` INTEGER NOT NULL, PRIMARY KEY (`id`))');
...
class _$MovieDao extends MovieDao {
  ...
  Stream<List<MovieEntity>> getAllMovies() {
    return _queryAdapter.queryListStream('SELECT * FROM movies',
        mapper: (Map<String, Object?> row) => MovieEntity(
            id: row['id'] as int,
            title: row['title'] as String,
            genre: row['genre'] as String,
            rating: row['rating'] as String,
            imageResId: row['image_res_id'] as int,
